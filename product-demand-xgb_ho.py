...
if __name__ == '__main__':
	...
	# Train model with the optimized hyperparameter; full training used 1000 boost rounds
	xgbr_ho = xgb.train(params, dtrain, num_boost_round=200)

	end = (time.time() - start) / 60
	print(f'\nDone! Total hyperparameter optimization and training duration: {round(end,2)} min')
